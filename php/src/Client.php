...
namespace APIVerve\Boggleboardgenerator;
...
/**
 * Client for the Boggle Board Generator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/boggleboardgenerator?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/boggleboardgenerator';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\BoggleboardgeneratorClient] {$message}\n";
        }
    }
}
