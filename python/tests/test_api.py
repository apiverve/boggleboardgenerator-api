...
class TestBoggleboardgeneratorAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = BoggleboardgeneratorAPIClient(self.api_key)

    @patch('apiverve_boggleboardgenerator.apiClient.requests.get')
