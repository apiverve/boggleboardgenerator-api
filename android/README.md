# Boggle Board Generator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:boggleboardgenerator-api:1.1.12'
}
```
...
```java
import com.apiverve.boggleboardgenerator.BoggleBoardGeneratorAPIClient;
import com.apiverve.boggleboardgenerator.APIResponse;
import com.apiverve.boggleboardgenerator.APIException;

// Initialize the client
BoggleBoardGeneratorAPIClient client = new BoggleBoardGeneratorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/boggleboardgenerator](https://docs.apiverve.com/ref/boggleboardgenerator)
...
- **Documentation:** [https://docs.apiverve.com/ref/boggleboardgenerator](https://docs.apiverve.com/ref/boggleboardgenerator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/boggleboardgenerator-api/issues)
