...
// Request contains the parameters for the Boggle Board Generator API.
//
// Parameters:
...
// ResponseData contains the data returned by the Boggle Board Generator API.
...
// BoardItem represents an item in the Board array.
