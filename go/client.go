// Package boggleboardgenerator provides a Go client for the Boggle Board Generator API.
//
// For more information, visit: https://apiverve.com/marketplace/boggleboardgenerator?utm_source=go&utm_medium=readme
package boggleboardgenerator
...
const (
	baseURL        = "https://api.apiverve.com/v1/boggleboardgenerator"
	defaultTimeout = 30 * time.Second
)

// Client is the Boggle Board Generator API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Boggle Board Generator API client.
...
// Execute makes a request to the Boggle Board Generator API with typed parameters.
//
